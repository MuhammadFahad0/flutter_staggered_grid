...
* Hardened grid layout calculations for zero-sized and tight-spacing edge cases.
* Added regression tests for reversed staggered tiles, delegate relayouts, and zero-extent layouts.

## 0.0.2
### Changed
* Updated the README for Git-based installation.
