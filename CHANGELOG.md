## 0.0.1
### Changed
* Forked the upstream 0.7.0 package into `flutter_staggered_grid`.
* Updated the package metadata and example app to use the new fork name.
...
## 0.6.2
### Fixed
* Issue with Quilted layout algorithm.
...
## 0.4.0-nullsafety.3
### Fixed
* LateInitializationError: Local `firstIndex` has not been initialized.
...
## 0.3.0
### Fixed
* Upgrade to AndroidX and fixes the BoxHitTestResult exception.
